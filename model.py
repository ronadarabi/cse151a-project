...
class MainModel(nn.Module):
    def __init__(
        ...
        self.PerceptionCriterion = PerceptionLoss().to(self.device)
    ...
    def backward_G(self):
        ...
        self.loss_G_percep = self.PerceptionCriterion(fake_rgb, real_rgb) * self.lambda_percep
        
        self.loss_G = self.loss_G_GAN + self.loss_G_L1 + self.loss_G_percep
    ...
    def compute_G_loss(self):
        ...
        loss_G_L1 = self.L1criterion(self.fake_color, self.ab_chan) * self.lambda_L1
        ...
        loss_G_percep = self.PerceptionCriterion(fake_rgb, real_rgb) * self.lambda_percep
        
        loss_G = loss_G_GAN + loss_G_L1 + loss_G_percep
        return loss_G
